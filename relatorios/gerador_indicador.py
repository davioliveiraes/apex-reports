...
def montar_tabela(chave, contas):
    """
    ...
    As contas já chegam consolidadas na seleção de campanhas escolhida na
    revisão; aqui não se filtra nada.
    """
    ...
    # Conta que não soma porque o export dela não traz a coluna da métrica —
    # nada a ver com o recorte de campanhas, que remove a conta inteira lá na
    # revisão em vez de deixá-la aqui com valor vazio.
...
def gerar_indicador(cliente, chave, contas, arquivo_saida):
    ...
    tabela = montar_tabela(chave, contas)
    contexto = {
        **tabela,
        "cliente": cliente,
        "periodo": periodo,
